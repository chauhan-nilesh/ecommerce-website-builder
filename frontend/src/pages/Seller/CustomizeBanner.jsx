...
function CustomizeBanner() {
  ...
  const handleSubmit = (e) => {
    ...
    axios.post("/api/store/upload/images", formdata)
      .then(res => {
          ...
          <form className='grid grid-flow-row'>
            ...
            {user.store.logo ?
              <>
                ...
                <img className='h-20 border border-gray-500 rounded-lg p-2' src={"/uploads/" + user.store.logo} alt="" />
              </>
              : ""}
            ...
            {user.store.favicon ?
              <>
                ...
                <img className='h-20 border border-gray-500 rounded-lg p-2' src={"/uploads/" + user.store.favicon} alt="" />
              </>
              : ""}
            ...
            {user.store.banner ?
              <>
                ...
                <img className='h-20 border border-gray-500 rounded-lg p-2' src={"/uploads/" + user.store.banner} alt="" />
              </>
              : ""}
            ...
            {user.store.mobileBanner ?
              <>
                ...
                <img className='h-20 border border-gray-500 rounded-lg p-2' src={"/uploads/" + user.store.mobileBanner} alt="" />
              </>
              : ""}
