...
function EditProduct() {
    ...
    const getCategoryData = async () => {
        try {
            setIsLoading(true);
            const storeResponse = await fetch("/api/user/current-user", {
                method: "GET",
            ...
            const categoryResponse = await fetch(`/api/category/get-data/${storeData.data.store._id}`, {
                method: "GET",
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.patch(`/api/product/update-product/${id}`, formData, {
                headers: {
