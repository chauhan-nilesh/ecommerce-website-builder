...
function Payment() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch(`/api/store/upi/add/${store._id}`, {
        method: "PATCH",
        headers: {
  ...
  const handleStatus = async (e) => {
    try {
      const response = await fetch(`/api/store/upi/change-status/${store._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json"
        },
  ...
  const deleteUpiId = async (e) => {
    e.preventDefault()
    try {
      const response = await fetch(`/api/store/upi/delete/${store._id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json"
        },
