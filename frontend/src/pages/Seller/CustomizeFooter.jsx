...
function CustomizeFooter() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        try {
            const response = await fetch(`/api/store/update/social/${storeId}`, {
              method: "PATCH",
              headers: {
    ...
    return (
        <div className='flex-grow h-screen'>
            <div className='lg:my-7 lg:mx-10 my-3 mx-5'>
                <h2 className='text-2xl lg:text-3xl text-zinc-900 font-bold tracking-tighter'>About Store & Social Links</h2>
                <div className='mt-8'>
                    <form onSubmit={handleSubmit} className='grid grid-flow-row'>
                        ...
                        <h2 className='mt-8 text-xl font-bold text-zinc-900'>Social Links</h2>
                        ...
                        <button className="btn btn-primary text-lg mt-6 w-28">Save</button>
                    </form>
                </div>
            </div>
        </div>
