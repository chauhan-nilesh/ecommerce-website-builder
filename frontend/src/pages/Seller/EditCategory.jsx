...
const EditCategory = () => {
    ...
    const handleFormSubmit = (e) => {
        ...
        axios.patch(`/api/category/edit/${id}`, formdata)
            .then(res => {
        ...
        <div className="md:flex items-center justify-center h-dvh lg:min-h-screen bg-white md:bg-gray-100">
            <div className="w-full max-w-md p-8 space-y-4 bg-white rounded-lg md:shadow-lg">
                ...
                <form onSubmit={handleFormSubmit} className="space-y-6">
                    ...
                    {categoryData?.image ?
                        <>
                            ...
                            <div>
                                ...
                                <img className='h-20 w-20 border mt-1 border-black p-3 rounded-md' src={"/uploads/"+categoryData?.image} alt={categoryData.name} />
                            </div>
                        </>
                        :
                        <div>
                    ...
                    <button
                        type="submit"
                        className="w-full px-4 py-2 font-bold text-white bg-blue-500 rounded-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-200"
                    >
                        Update Category
                    </button>
                </form>
