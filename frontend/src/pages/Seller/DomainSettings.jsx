        ...
        <div className='lg:my-7 lg:mx-10 my-3 mx-3'>
          ...
          <div className='mt-8'>
            ...
            <div className='mt-4 flex'>
              ...
              <a className='ml-2 font-bold underline text-xl' href={`https://${store.subdomain}.${import.meta.env.VITE_HOSTNAME}`}>{store.subdomain + "." + import.meta.env.VITE_HOSTNAME}</a>
            </div>
            {/* <h2 className='mt-12 lg:text-3xl tracking-tighter font-bold text-zinc-900 text-2xl'>Add custom domain</h2>
            <input
              type="text"
              name='customDomain'
              id='customDomain'
              className="w-full lg:w-auto px-3 py-2 bg-transparent border border-gray-600 rounded mt-2"
            /> */}
