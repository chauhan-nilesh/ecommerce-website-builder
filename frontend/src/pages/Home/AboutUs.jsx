      ...
      <section className="bg-white p-8 rounded-lg lg:mx-28">
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            At Eazzy Store, our mission is to empower entrepreneurs and businesses of all sizes by providing an easy-to-use, robust e-commerce website builder. We strive to enable our users to create beautiful, functional, and successful online stores with minimal effort.
          </p>
        </div>
        <div className="mb-8">
