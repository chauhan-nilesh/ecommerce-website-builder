    ...
    return (
        <>
            <div className='hidden md:flex'>
                {store.banner ?
                    <div className='flex justify-center items-center text-4xl w-full h-auto text-white font-bold' style={{ color: color2, backgroundColor: color1 }}>
                        <img className='h-full w-full' src={import.meta.env.VITE_DOMAIN_NAME + "/uploads/" + store.banner} alt="store banner" />
                    </div>
            ...
            <div className='md:hidden flex'>
                {store.mobileBanner ?
                    <div className='flex justify-center items-center text-4xl w-full h-auto text-white font-bold' style={{ color: color2, backgroundColor: color1 }}>
                        <img className='h-full w-full' src={import.meta.env.VITE_DOMAIN_NAME + "/uploads/" + store.mobileBanner} alt="store banner" />
                    </div>
                    : <div className='flex justify-center items-center text-4xl w-full h-96 text-white font-bold' style={{ color: color2, backgroundColor: color1 }}>
                        Sample Banner Text
                    </div>
