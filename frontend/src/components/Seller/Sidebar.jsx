    ...
    return (
        <>
            <div className="flex items-center p-2 space-x-4">
                {user.store.favicon ?
                    <img src={"/uploads/" + user.store.favicon} alt="" className="w-12 h-12 rounded-full bg-gray-500" />
                    :
                ...
                <div>
                    ...
                    <span className="flex items-center space-x-1">
                        <Link to={"http://" + user.store.subdomain + ":5173"} className="text-xs hover:underline text-gray-600">View store</Link>
                    </span>
                </div>
            </div>
